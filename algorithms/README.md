...
- [coding-interview-university](https://github.com/jwasham/coding-interview-university) に記載されている項目を学習する

## 利用する言語

- C++で実装する
- 一部は golang で実装するかもしれない

## なにをもって学習したとするのか

- 〇〇のコースを終えた、というのではなく、どんなデータ構造を実装できたかで判定する
- 学習したことは何かしらの code と、学習した上で気をつけなくてはいけない事柄をメモ書きして github に push する

## どのように学習するのか

- 各項目ごとには基本的に issues を立てる
- 最終的にレポジトリにコミットするのがゴールだが、学習すること自体は process なので、その過程を記録するために issue に自由に記述する
